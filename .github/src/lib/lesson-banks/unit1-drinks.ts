...
export const unit1DrinksBank: Record<string, TieredBank> = {
  ...
  "الكلمات الأساسية": {
    ...
    t2: [
      ...
      { id:"dr1-t2-3", type:"listen_select", listenSentence:"No juice", options:["juice","milk","tea","coffee"], correctAnswer:"juice", explanation:"does not drink juice = لا يشرب عصير", xp:14 },
    ...
    t3: [
      ...
      { id:"dr1-t3-3", type:"listen_select", listenSentence:"Cold water please", options:["water","juice","milk","tea"], correctAnswer:"water", explanation:"a glass of cold water = كوب ماء بارد", xp:18 },
      { id:"dr1-t3-4", type:"word_order", sentence:"She drinks warm milk", correctAnswer:"She drinks warm milk", explanation:"always + فعل (بعد الفاعل مباشرة)", xp:18 },
  ...
  "كلمات جديدة": {
    t0: [
      ...
      { id:"dr2-t0-4", type:"translate", arabic:"من فضلك", options:["please","sorry","thank you","more"], correctAnswer:"please", explanation:"please = من فضلك 🙏", xp:10 },
    ...
    t1: [
      ...
      { id:"dr2-t1-6", type:"translate", arabic:"آسف", options:["sorry","please","yes","no"], correctAnswer:"sorry", explanation:"sorry = آسف 😔", xp:12 },
    ...
    t2: [
      ...
      { id:"dr2-t2-3", type:"listen_select", listenSentence:"Thank you, tea", options:["tea","coffee","milk","juice"], correctAnswer:"tea", explanation:"thank you for the tea = شكراً على الشاي", xp:14 },
      ...
      { id:"dr2-t2-6", type:"translate", arabic:"المزيد", options:["more","some","please","water"], correctAnswer:"more", explanation:"more = المزيد 🔄", xp:14 },
    ...
    t3: [
      ...
      { id:"dr2-t3-3", type:"listen_select", listenSentence:"No juice, sorry", options:["juice","milk","water","tea"], correctAnswer:"juice", explanation:"run out of = نفد — we ran out of juice = نفد العصير", xp:18 },
      { id:"dr2-t3-4", type:"word_order", sentence:"Yes, more coffee please", correctAnswer:"Yes, more coffee please", explanation:"I would love some = أود بعض — أكثر أدباً من I want", xp:19 },
      ...
      { id:"dr2-t3-7", type:"translate", arabic:"شكراً", options:["thank you","sorry","please","yes"], correctAnswer:"thank you", explanation:"thank you = شكراً 🙏", xp:18 },
  ...
  "جمل كاملة": {
    t0: [
      ...
      { id:"dr3-t0-2", type:"listen_select", listenSentence:"Some coffee please", options:["coffee","tea","juice","milk"], correctAnswer:"coffee", explanation:"I would like some coffee = أود بعض القهوة", xp:12 },
      ...
      { id:"dr3-t0-5", type:"translate", arabic:"أودّ", options:["would like","want","have","need"], correctAnswer:"would like", explanation:"would like = أود / أرغب في 🤔", xp:12 },
    ...
    t1: [
      ...
      { id:"dr3-t1-3", type:"listen_select", listenSentence:"Juice or water", options:["juice","coffee","milk","tea"], correctAnswer:"juice", explanation:"juice or water — الأول المذكور هو juice", xp:14 },
      { id:"dr3-t1-4", type:"word_order", sentence:"Yes, coffee please", correctAnswer:"Yes, coffee please", explanation:"I would love = أود جداً — أقوى من would like", xp:14 },
      ...
      { id:"dr3-t1-7", type:"translate", arabic:"بعض", options:["some","more","any","the"], correctAnswer:"some", explanation:"some = بعض 🔢", xp:14 },
    ...
    t2: [
      ...
      { id:"dr3-t2-3", type:"listen_select", listenSentence:"Warm milk please", options:["milk","coffee","juice","water"], correctAnswer:"milk", explanation:"warm milk = حليب دافئ — before sleeping = قبل النوم", xp:16 },
      { id:"dr3-t2-4", type:"word_order", sentence:"No more coffee thanks", correctAnswer:"No more coffee thanks", explanation:"would not like any more = لا أريد مزيداً — any more مع النفي", xp:16 },
    ...
    t3: [
      ...
      { id:"dr3-t3-3", type:"listen_select", listenSentence:"Cold water please", options:["water","juice","milk","tea"], correctAnswer:"water", explanation:"would have preferred = كنت سأفضّل — to be honest = بصراحة", xp:20 },
      { id:"dr3-t3-4", type:"word_order", sentence:"Sorry, no milk", correctAnswer:"Sorry, no milk", explanation:"I am afraid = للأسف — run out of = نفد", xp:20 },
  ...
  "تحدي الوحدة": {
    t0: [
      ...
      { id:"ch-t0-3", type:"listen_select", listenSentence:"No thanks, water", options:["water","juice","milk","coffee"], correctAnswer:"water", explanation:"I have some water = لديّ بعض الماء", xp:15 },
    ...
    t1: [
      ...
      { id:"ch-t1-3", type:"listen_select", listenSentence:"More milk please", options:["milk","juice","coffee","tea"], correctAnswer:"milk", explanation:"some more milk = مزيد من الحليب — a little water = قليل من الماء", xp:16 },
      ...
      { id:"ch-t1-5", type:"word_order", sentence:"Juice or milk?", correctAnswer:"Juice or milk?", explanation:"more juice or some milk — عرض خيارين بكميات", xp:16 },
    ...
    t2: [
      ...
      { id:"ch-t2-3", type:"listen_select", listenSentence:"Water or juice", options:["water","coffee","milk","tea"], correctAnswer:"water", explanation:"we only have water and juice left = لم يتبق إلا الماء والعصير", xp:18 },
      { id:"ch-t2-4", type:"word_order", sentence:"Thanks, great coffee", correctAnswer:"Thanks, great coffee", explanation:"was wonderful = ماضي — نتحدث عن شيء انتهينا منه", xp:18 },
    ...
    t3: [
      ...
      { id:"ch-t3-3", type:"listen_select", listenSentence:"No milk, no juice", options:["milk","coffee","water","tea"], correctAnswer:"milk", explanation:"run out of both milk and juice = نفد كل من الحليب والعصير", xp:22 },
      { id:"ch-t3-4", type:"word_order", sentence:"Help yourself please", correctAnswer:"Help yourself please", explanation:"do help yourself = تفضل تماماً (do للتأكيد) — Not at all = بكل سرور", xp:22 },
