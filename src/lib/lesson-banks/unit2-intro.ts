...
export const unit2IntroBank: Record<string, TieredBank> = {
  ...
  "ما اسمك؟": {
    t0: [
      ...
      { id:"in1-t0-9", type:"matching", pairs:[{en:"name",ar:"اسم"},{en:"hello",ar:"مرحباً"},{en:"what",ar:"ما"},{en:"I am",ar:"أنا"},{en:"your",ar:"خاصتك"},{en:"friend",ar:"صديق"},{en:"hi",ar:"أهلاً"},{en:"you",ar:"أنت"}], correctAnswer:"matched", explanation:"أحسنت! طابقت الكلمات الأساسية", xp:15 },
    ],
    t1: [
      ...
      { id:"in1-t1-8", type:"matching", pairs:[{en:"my name is",ar:"اسمي"},{en:"your name",ar:"اسمك"},{en:"hello",ar:"مرحباً"},{en:"what",ar:"ما"},{en:"I am",ar:"أنا"},{en:"hi",ar:"أهلاً"},{en:"friend",ar:"صديق"},{en:"name",ar:"اسم"}], correctAnswer:"matched", explanation:"رائع!", xp:15 },
    ...
    t2: [
      ...
      { id:"in1-t2-7", type:"matching", pairs:[{en:"nice to meet you",ar:"سررت بلقائك"},{en:"my name is",ar:"اسمي"},{en:"hello",ar:"مرحباً"},{en:"what is",ar:"ما هو"},{en:"your name",ar:"اسمك"},{en:"friend",ar:"صديق"},{en:"hi",ar:"أهلاً"},{en:"name",ar:"اسم"}], correctAnswer:"matched", explanation:"ممتاز!", xp:16 },
    ...
    t3: [
      ...
      { id:"in1-t3-5", type:"matching", pairs:[{en:"name",ar:"اسم"},{en:"hello",ar:"مرحباً"},{en:"nice to meet you",ar:"سررت بلقائك"},{en:"what",ar:"ما"},{en:"my name is",ar:"اسمي"},{en:"hi",ar:"أهلاً"},{en:"friend",ar:"صديق"},{en:"your",ar:"خاصتك"}], correctAnswer:"matched", explanation:"رائع! راجعت كلمات التقديم", xp:18 },
  ...
  "من أين أنت؟": {
    t0: [
      ...
      { id:"in2-t0-9", type:"matching", pairs:[{en:"from",ar:"من"},{en:"where",ar:"أين"},{en:"you",ar:"أنت"},{en:"I am",ar:"أنا"},{en:"are",ar:"تكون"},{en:"country",ar:"بلد"},{en:"city",ar:"مدينة"},{en:"here",ar:"هنا"}], correctAnswer:"matched", explanation:"أحسنت!", xp:15 },
    ],
    t1: [
      ...
      { id:"in2-t1-7", type:"matching", pairs:[{en:"where are you",ar:"أين أنت"},{en:"I am from",ar:"أنا من"},{en:"you",ar:"أنت"},{en:"from",ar:"من"},{en:"where",ar:"أين"},{en:"city",ar:"مدينة"},{en:"country",ar:"بلد"},{en:"here",ar:"هنا"}], correctAnswer:"matched", explanation:"رائع!", xp:15 },
    ...
    t2: [
      ...
      { id:"in2-t2-7", type:"matching", pairs:[{en:"he is from",ar:"هو من"},{en:"she is from",ar:"هي من"},{en:"I am from",ar:"أنا من"},{en:"where",ar:"أين"},{en:"from",ar:"من"},{en:"country",ar:"بلد"},{en:"city",ar:"مدينة"},{en:"here",ar:"هنا"}], correctAnswer:"matched", explanation:"ممتاز!", xp:16 },
    ...
    t3: [
      ...
      { id:"in2-t3-5", type:"matching", pairs:[{en:"where",ar:"أين"},{en:"from",ar:"من"},{en:"you",ar:"أنت"},{en:"I am",ar:"أنا"},{en:"country",ar:"بلد"},{en:"city",ar:"مدينة"},{en:"here",ar:"هنا"},{en:"are",ar:"تكون"}], correctAnswer:"matched", explanation:"رائع!", xp:18 },
  ...
  "عائلتك": {
    t0: [
      ...
      { id:"in3-t0-9", type:"matching", pairs:[{en:"mother",ar:"أم"},{en:"father",ar:"أب"},{en:"brother",ar:"أخ"},{en:"sister",ar:"أخت"},{en:"family",ar:"عائلة"},{en:"son",ar:"ابن"},{en:"daughter",ar:"بنت"},{en:"baby",ar:"رضيع"}], correctAnswer:"matched", explanation:"أحسنت! طابقت أفراد العائلة", xp:15 },
    ],
    t1: [
      ...
      { id:"in3-t1-7", type:"matching", pairs:[{en:"family",ar:"عائلة"},{en:"mother",ar:"أم"},{en:"this is",ar:"هذا/هذه"},{en:"I have",ar:"لديّ"},{en:"father",ar:"أب"},{en:"daughter",ar:"بنت"},{en:"son",ar:"ابن"},{en:"baby",ar:"رضيع"}], correctAnswer:"matched", explanation:"رائع!", xp:15 },
    ...
    t2: [
      ...
      { id:"in3-t2-7", type:"matching", pairs:[{en:"brother",ar:"أخ"},{en:"sister",ar:"أخت"},{en:"father",ar:"أب"},{en:"mother",ar:"أم"},{en:"family",ar:"عائلة"},{en:"grandfather",ar:"جد"},{en:"grandmother",ar:"جدة"},{en:"son",ar:"ابن"}], correctAnswer:"matched", explanation:"ممتاز!", xp:16 },
    ...
    t3: [
      ...
      { id:"in3-t3-5", type:"matching", pairs:[{en:"family",ar:"عائلة"},{en:"mother",ar:"أم"},{en:"father",ar:"أب"},{en:"brother",ar:"أخ"},{en:"sister",ar:"أخت"},{en:"son",ar:"ابن"},{en:"daughter",ar:"بنت"},{en:"grandfather",ar:"جد"}], correctAnswer:"matched", explanation:"رائع! راجعت كلمات العائلة", xp:18 },
  ...
  "تحدي الوحدة": {
    t0: [
      ...
      { id:"inc-t0-5", type:"matching", pairs:[{en:"name",ar:"اسم"},{en:"from",ar:"من"},{en:"family",ar:"عائلة"},{en:"hello",ar:"مرحباً"},{en:"where",ar:"أين"},{en:"friend",ar:"صديق"},{en:"country",ar:"بلد"},{en:"mother",ar:"أم"}], correctAnswer:"matched", explanation:"أحسنت!", xp:16 },
    ...
    t1: [
      ...
      { id:"inc-t1-5", type:"matching", pairs:[{en:"mother",ar:"أم"},{en:"father",ar:"أب"},{en:"brother",ar:"أخ"},{en:"sister",ar:"أخت"},{en:"family",ar:"عائلة"},{en:"son",ar:"ابن"},{en:"daughter",ar:"بنت"},{en:"baby",ar:"رضيع"}], correctAnswer:"matched", explanation:"رائع!", xp:17 },
    ...
    t2: [
      ...
      { id:"inc-t2-5", type:"matching", pairs:[{en:"nice to meet you",ar:"سررت بلقائك"},{en:"where are you from",ar:"من أين أنت"},{en:"my name is",ar:"اسمي"},{en:"family",ar:"عائلة"},{en:"hello",ar:"مرحباً"},{en:"friend",ar:"صديق"},{en:"country",ar:"بلد"},{en:"city",ar:"مدينة"}], correctAnswer:"matched", explanation:"ممتاز!", xp:18 },
    ...
    t3: [
      ...
      { id:"inc-t3-5", type:"matching", pairs:[{en:"name",ar:"اسم"},{en:"from",ar:"من"},{en:"family",ar:"عائلة"},{en:"nice to meet you",ar:"سررت بلقائك"},{en:"hello",ar:"مرحباً"},{en:"where",ar:"أين"},{en:"mother",ar:"أم"},{en:"friend",ar:"صديق"}], correctAnswer:"matched", explanation:"رائع! أتقنت الوحدة 👑", xp:22 },
